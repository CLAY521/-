...
enum gzImageInfoClass
{
	...
	GZ_IMAGE_INFO_CLASS_ALTITUDE,
	GZ_IMAGE_INFO_CLASS_DEPTH,
	GZ_IMAGE_INFO_CLASS_DENSITY,
	GZ_IMAGE_INFO_CLASS_FEATURE,	// See below for feature
	GZ_IMAGE_INFO_CLASS_LAYER,		// See below for layer
};

GZ_DECLARE_DYNAMIC_ENUM(gzImageInfoClass);

//! Mutiple features per layer
enum gzImageInfoFeatureType
{
	GZ_IMAGE_INFO_FEATURE_TYPE_IMAGE_DATA,	// Just plain image data
	GZ_IMAGE_INFO_FEATURE_TYPE_DEFAULT,		// Default feature encoding
...
enum gzImageInfoLayerType
{
	GZ_IMAGE_INFO_LAYER_TYPE_IMAGE_DATA,	// Just plain image data
	GZ_IMAGE_INFO_LAYER_TYPE_GRASSLAND,		// Grass and low shrubbery
...
const gzString GZ_IMAGE_INFO_COORD_SYS = "ImI-CoordSystem";

//! Coordinate Swizzle to x,y,z
const gzString GZ_IMAGE_INFO_SWIZZLE = "ImI-Swizzle";

//! Image to World homography 3x3 matrix (double)
const gzString GZ_IMAGE_INFO_IMAGE_TO_WORLD_HOMOGRAPHY = "ImI-Wrld-Hom";

const gzString GZ_IMAGE_INFO_PIXEL_X_SIZE = "ImI-Pixel-X-size";
const gzString GZ_IMAGE_INFO_PIXEL_Y_SIZE = "ImI-Pixel-Y-size";
const gzString GZ_IMAGE_INFO_PIXEL_Z_SIZE = "ImI-Pixel-Z-size";

const gzString GZ_IMAGE_INFO_MIN_TEXEL_AREA = "ImI-Texel-minArea";
const gzString GZ_IMAGE_INFO_MAX_TEXEL_AREA = "ImI-Texel-maxArea";

const gzString GZ_IMAGE_INFO_CLASS = "ImI-Class";

const gzString GZ_IMAGE_INFO_FEATURE_TYPE = "ImI-Class-Feature-Type";

const gzString GZ_IMAGE_INFO_LAYER_TYPE = "ImI-Class-Layer-Type";
...
public:
	...
	*/
	...
	GZ_BASE_EXPORT gzUInt32	getWidth() { return m_width; }

	//!Returns the height of the image.
	GZ_BASE_EXPORT gzUInt32	getHeight() { return m_height; }

	//!Returns the depth of the image.
	GZ_BASE_EXPORT gzUInt32	getDepth() { return m_depth; }
...
public:
	...
	GZ_BASE_EXPORT static gzVoid	unregisterManager(gzImageManager* manager);
	...
	GZ_BASE_EXPORT static gzString	getAllExtensions();
