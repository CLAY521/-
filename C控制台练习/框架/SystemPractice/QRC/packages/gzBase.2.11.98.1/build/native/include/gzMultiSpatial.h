...
public:
	...
	gzSpatialCoordinate<SIZE,VALUETYPE,DIVS>(const VALUETYPE *list=NULL);
...
public:
	...
	gzBool		nearCandidate(const Spatial &position,T &data,Spatial *pos=NULL,Spatial *delta=NULL);
...
template <class T,gzUInt32 SIZE,class VALUETYPE,gzUInt32 DIVS> inline gzVoid gzMultiSpatial<T,SIZE,VALUETYPE,DIVS>::insert(gzUInt32 level,const gzSpatialCoordinate<SIZE,VALUETYPE,DIVS> &position,const T &data,const gzSpatialCoordinate<SIZE,VALUETYPE,DIVS> &delta)
{
	...
	_holder *holder=m_space,*parent=NULL;
...
public:
	...
	gzBool operator()(T &data,gzSpatialCoordinate<SIZE,VALUETYPE,DIVS> *pos=NULL,gzSpatialCoordinate<SIZE,VALUETYPE,DIVS> *delta=NULL);
