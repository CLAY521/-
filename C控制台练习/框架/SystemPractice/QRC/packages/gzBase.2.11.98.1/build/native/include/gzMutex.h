...
public:
	...
	GZ_BASE_EXPORT gzCleanupReference( gzReference *pointer=NULL,gzInt32 id=0);
	...
	GZ_BASE_EXPORT static gzVoid cleanUpReferences(gzInt32 id=GZ_CLEANUP_ALL);
