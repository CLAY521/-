...
public:
	...
	GZ_BASE_EXPORT gzSerializeAdapterHttp(const gzString &url,gzSerializeAction action,gzSerializeAdapterFlags flags, const gzString &password, gzString *errorString=NULL, gzSerializeAdapterError *errorType=NULL);
