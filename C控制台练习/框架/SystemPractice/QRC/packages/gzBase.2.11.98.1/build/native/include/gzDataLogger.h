...
public:
	...
	GZ_BASE_EXPORT virtual gzVoid log(gzDouble timestamp,GZ_DYNAMIC_ATTRIBUTE_LIST,gzSerializeAdapter *adapter=NULL)=0;
};
...
public:
	...
	GZ_BASE_EXPORT	virtual gzVoid log(gzDouble timestamp,GZ_DYNAMIC_ATTRIBUTE_LIST,gzSerializeAdapter *adapter=NULL);
