...
public:
	...
	GZ_BASE_EXPORT gzUserData *	getUserData(	const gzString &name , gzUserData *parent=NULL) const;
...
public:
	...
	GZ_BASE_EXPORT gzObjectSender(const gzString &channelName,gzSerializeAdapter *adapter=NULL);
...
public:
	...
	GZ_BASE_EXPORT gzObjectReceiver(const gzString &channelName,gzSerializeAdapter *adapter=NULL);
