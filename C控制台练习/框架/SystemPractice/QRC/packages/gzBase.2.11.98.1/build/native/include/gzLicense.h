...
public:
	...
	GZ_BASE_EXPORT static gzUInt64		splashLicenseText(const gzString &header,const gzString &text,gzUInt64 checkid=0);
...
public:
	...
	GZ_BASE_EXPORT static gzBool hasAllowedFeature(const gzString &featureName,gzFeatureInfo *info=NULL);
