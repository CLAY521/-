...
public:
	...
	template <class Y> gzVec3_ cross(const gzVec3_<Y> &vector) const GZ_NOEXCEPT(TRUE)
	{
	...
	gzVec3_ operator-() GZ_NOEXCEPT(TRUE)
	{
		return gzVec3_(-v1, -v2, -v3);
	}

	template <class Y> gzVec3_ & operator+=(const gzVec3_<Y> &vector) GZ_NOEXCEPT(TRUE)
	{
		v1 += vector.v1;
		v2 += vector.v2;
		v3 += vector.v3;
	...
	template <class Y> gzVec3_	operator * (const Y &val) const GZ_NOEXCEPT(TRUE)
	{
		return gzVec3_((T)(v1*val), (T)(v2*val), (T)(v3*val));
	}

	gzVec3_ & operator *= (const T &val) GZ_NOEXCEPT(TRUE)
	{
		v1 *= val;
		v2 *= val;
		v3 *= val;
	...
	gzVec3_	operator / (const T &val) const GZ_NOEXCEPT(TRUE)
	{
		T invlen(1 / val);
		return gzVec3_(v1*invlen, v2*invlen, v3*invlen);
	}
	...
	template <class Y> gzVec3_ operator - (const gzVec3_<Y> &vector_b) const GZ_NOEXCEPT(TRUE)
	{
	...
	gzVec3_ orthogonal (const gzVec3_ &base) const GZ_NOEXCEPT(TRUE)
	{
...
public:
	...
	gzVec4_ operator-() GZ_NOEXCEPT(TRUE)
	{
		return gzVec4_(-v1, -v2, -v3,-v4);
	}

	template <class Y>  gzVec4_ & operator+=(const gzVec4_<Y> &vector) GZ_NOEXCEPT(TRUE)
	{
		v1 += vector.v1;
		v2 += vector.v2;
		v3 += vector.v3;
	...
	gzVec4_	operator * (const T &val) const GZ_NOEXCEPT(TRUE)
	{
		return gzVec4_(v1*val, v2*val, v3*val,v4*val);
	}

	gzVec4_ & operator *= (const T &val) GZ_NOEXCEPT(TRUE)
	{
		v1 *= val;
		v2 *= val;
		v3 *= val;
	...
	template <class Y> gzVec4_ operator - (const gzVec4_<Y> &vector_b) const GZ_NOEXCEPT(TRUE)
	{
	...
	template <class Y> gzVec3_<T> operator - (const gzVec3_<Y> &vector_b) const GZ_NOEXCEPT(TRUE)
	{
...
public:
	...
	gzMatrix2_ operator-() GZ_NOEXCEPT(TRUE)
	{
		return gzMatrix2_<T>(gzVec2_<T>(-v11, -v21), gzVec2_<T>(-v12, -v22));
	}

	template <class Y> gzMatrix2_ & operator+=(const gzMatrix2_<Y> &mat) GZ_NOEXCEPT(TRUE)
	{
		v11 += mat.v11;
		v12 += mat.v12;
		v21 += mat.v21;
	...
	gzMatrix2_	operator * (const T &val) const GZ_NOEXCEPT(TRUE)
	{
		return gzMatrix2_<T>(gzVec2_<T>(v11*val, v21*val), gzVec2_<T>(v12*val, v22*val));
	}
	
	gzMatrix2_ & operator *= (const T &val) GZ_NOEXCEPT(TRUE)
	{
		v11 *= val;
		v12 *= val;
		v21 *= val;
	...
	template <class Y> gzMatrix2_ operator - (const gzMatrix2_<Y> &mat) const GZ_NOEXCEPT(TRUE)
	{
	...
	template <class Y> gzVec2_<T> operator * (const gzVec2_<Y> &vec) const GZ_NOEXCEPT(TRUE)
	{
		gzVec2_<T> res;
...
public:
	...
	gzMatrix3_ operator-() GZ_NOEXCEPT(TRUE)
	{
		return gzMatrix3_<T>(gzVec3_<T>(-v11, -v21, -v31), gzVec3_<T>(-v12, -v22, -v32), gzVec3_<T>(-v13, -v23, -v33));
	}

	template <class Y> gzMatrix3_ & operator+=(const gzMatrix3_<Y> &mat) GZ_NOEXCEPT(TRUE)
	{
		v11 += mat.v11;
		v12 += mat.v12;
		v13 += mat.v13;
	...
	gzMatrix3_	operator * (const T &val) const GZ_NOEXCEPT(TRUE)
	{
	...
	gzMatrix3_ & operator *= (const T &val) GZ_NOEXCEPT(TRUE)
	{
		v11 *= val;
		v12 *= val;
		v13 *= val;
	...
	template <class Y> gzMatrix3_ operator - (const gzMatrix3_<Y> &mat) const GZ_NOEXCEPT(TRUE)
	{
	...
	template <class Y> gzVec3_<T> operator * (const gzVec3_<Y> &vec) const GZ_NOEXCEPT(TRUE)
	{
		gzVec3_<T> res;
...
public:
	...
	{
		v11 = copy.v11;	v12 = copy.v12;	v13 = copy.v13;	v14 = copy.v14;
		v21 = copy.v21;	v22 = copy.v22;	v23 = copy.v23;	v24 = copy.v24;
		v31 = copy.v31;	v32 = copy.v32;	v33 = copy.v33;	v34 = copy.v34;
		v41 = copy.v41;	v42 = copy.v42;	v43 = copy.v43;	v44 = copy.v44;
		return *this;
	}
	...
	gzMatrix4_ operator-() GZ_NOEXCEPT(TRUE)
	{
		return gzMatrix4_<T>(
	...
	template <class Y> gzMatrix4_ & operator+=(const gzMatrix4_<Y> &mat) GZ_NOEXCEPT(TRUE)
	{
	...
	gzMatrix4_ operator * (const T &val) const GZ_NOEXCEPT(TRUE)
	{
		return gzMatrix4_<T>(
	...
	gzMatrix4_ & operator *= (const T &val) GZ_NOEXCEPT(TRUE)
	{
	...
	template <class Y> gzMatrix4_ operator - (const gzMatrix4_<Y> &mat) const GZ_NOEXCEPT(TRUE)
	{
		gzMatrix4_<T> res;
	...
	template <class Y> gzVec4_<T> operator * (const gzVec4_<Y> &vec) const GZ_NOEXCEPT(TRUE)
	{
		gzVec4_<T> res;
	...
	template <class Y> gzVec4_<T> operator * (const gzVec3_<Y> &vec) const GZ_NOEXCEPT(TRUE)
	{
		gzVec4_<T> res;
...
public:
	...
	gzQuaternion_(const T& angle, const gzVec3_<T> &n, const T& norm = 1)
	{
		T len = n.length();
	...
	gzVoid	decompose_euler_yxz(T &heading, T& pitch, T& roll)
	{
		rotationMatrix().decompose_euler_yxz(heading, pitch, roll);
	}

	gzVoid	decompose_euler_zxy(T& heading, T& pitch, T& roll)
	{
		rotationMatrix().decompose_euler_zxy(heading, pitch, roll);
	}

	gzVoid	decompose_euler_xyz(T& heading, T& pitch, T& roll)
	{
...
GZ_BASE_EXPORT const gzMatrix4 &gzGetUnitMatrix() GZ_NOEXCEPT(TRUE);

GZ_BASE_EXPORT gzVoid gzGetVectorRotation(const gzMatrix4 &mat, gzVec3 &vec, gzFloat &angle, const gzVec3 &base=GZ_ONE_VEC3) GZ_NOEXCEPT(TRUE);
GZ_BASE_EXPORT gzVoid gzGetTranslationMatrix( gzMatrix4 &matrix,gzFloat dx , gzFloat dy , gzFloat dz ) GZ_NOEXCEPT(TRUE);
GZ_BASE_EXPORT gzVoid gzGetTranslationMatrix( gzMatrix4 &matrix,const gzVec3 &translation ) GZ_NOEXCEPT(TRUE);

GZ_BASE_EXPORT gzVoid gzGetScaleMatrix( gzMatrix4 &matrix,gzFloat dx , gzFloat dy , gzFloat dz ) GZ_NOEXCEPT(TRUE);
GZ_BASE_EXPORT gzVoid gzGetScaleMatrix( gzMatrix4 &matrix, const gzVec3 &scale ) GZ_NOEXCEPT(TRUE);

GZ_BASE_EXPORT gzVoid gzGetBaseMatrix( gzMatrix4 &matrix , const gzVec3 &base ) GZ_NOEXCEPT(TRUE);
GZ_BASE_EXPORT gzVoid gzGetBaseMatrix( gzMatrix4 &matrix , const gzVec3 &x_base,const gzVec3 &y_base) GZ_NOEXCEPT(TRUE);

GZ_BASE_EXPORT gzVoid gzGetRotationMatrix( gzMatrix4 &matrix , const gzVec3 &base , gzFloat angle)GZ_NOEXCEPT(TRUE);	
GZ_BASE_EXPORT gzVoid gzGetRotationMatrix( gzMatrix4 &matrix , gzFloat heading , gzFloat pitch , gzFloat roll) GZ_NOEXCEPT(TRUE);  

GZ_BASE_EXPORT gzVoid gzGetHPR( const gzMatrix4 &matrix , gzFloat& heading , gzFloat& pitch , gzFloat& roll) GZ_NOEXCEPT(TRUE);

GZ_BASE_EXPORT gzVoid gzGetRotationMatrix( gzMatrix4 &matrix , const gzVec3 &orientation) GZ_NOEXCEPT(TRUE); 
...
GZ_BASE_EXPORT inline gzFloat gzGetNormDot( const gzVec3 & a , const gzVec3 & b, const gzVec3 &c , const gzVec3 &dir) GZ_NOEXCEPT(TRUE)
{
...
GZ_BASE_EXPORT inline gzVoid getExtendedVector(gzVec3 &dest, const gzVec3 &from, const gzVec3 &to , const gzFloat &lengthSq2) GZ_NOEXCEPT(TRUE)
{
