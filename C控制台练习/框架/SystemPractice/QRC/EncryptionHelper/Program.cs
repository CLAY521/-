...
namespace EncryptionHelper
{
    ...
    public class PasswordHelper
    {
        ...
        /// <returns></returns>
        public static string Md5Salt(string pwd, string salt)
        {
            return Program.GetMD5AndSHA256(Program.GetMD5(pwd) + salt);
        }
        /// <summary>
        /// 已经经过MD5的pwd加盐
        /// </summary>
        ...
        /// <param name="salt"></param>
        /// <returns></returns>
        public static string Md5PwdAddSalt(string pwd, string salt)
        {
            return Program.GetMD5AndSHA256(pwd + salt);
        }
    }
